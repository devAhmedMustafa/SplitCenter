...
class RemoteService:
    ...
    def get_all_remote_repos(self):
        try:
            return self.remote_repo.get_all_repositories()
        except Exception as e:
            raise ValueError(f"Failed to get all remote repositories: {str(e)}")
    ...
    def get_remote_repo_byurl(self, repo_url: str):
        try:
